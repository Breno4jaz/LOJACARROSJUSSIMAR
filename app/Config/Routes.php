...
$routes->match(['get', 'post'],'excluir/carro/(:num)', 'Home::excluir/$1');
$routes->match(['get', 'post'],'excluir/carro/(:num)', 'Home::excluir/$1');
$routes->match(['get', 'post'],'editar/(:num)', 'Home::editar/$1');
$routes->match(['get', 'post'],'editar/carro/(:num)', 'Home::editarCarros/$1');
$routes->match(['get', 'post'],'editar/moto/(:num)', 'Home::editarMotos/$1');
